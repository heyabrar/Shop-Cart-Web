        ...
        <>
            <Box width={{ base: '90%', lg: '85%' }} m='auto' mt={{ base: '60px', md: '50px', lg: '70px' }}>
                ...
                <Flex gap='20px' direction={{ base: 'column', md: 'row'}} mt='30px'>
                    <Box>
                        <Box>
                            <Image src="https://uploads-ssl.webflow.com/63e857eaeaf853471d5335ff/63e8c4e6cd3678e82164f755_furniture%20village-min.png" borderTopRadius='10px' />
                        </Box>

                        <Box padding={{ base: '10px' }} lineHeight={{ base: '40px', md:  '50px'}} bg='#f5f6f6' borderBottomRadius='10px'>
                    ...
                    <Box>
                        <Box>
                            <Image src="https://uploads-ssl.webflow.com/63e857eaeaf853471d5335ff/63e8c4e6037f3b456acf2024_Fashion%20world-min.png" borderTopRadius='10px'/>
                        </Box>
                        <Box padding={{ base: '10px' }} lineHeight={{ base: '40px', md:  '50px'}} bg='#f5f6f6'  borderBottomRadius='10px'>
